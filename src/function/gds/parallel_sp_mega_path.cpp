...
class ParallelMegaSPPaths : public GDSAlgorithm {
public:
    ParallelMegaSPPaths() = default;
    ParallelMegaSPPaths(const ParallelMegaSPPaths& other) = default;
    ...
    inline bool hasPathOutput() const override {
        return true;
    }
    ...
    std::unique_ptr<GDSAlgorithm> copy() const override {
        return std::make_unique<ParallelMegaSPPaths>(*this);
    }
};

function_set ParallelMegaSPPathsFunction::getFunctionSet() {
    function_set result;
    auto function = std::make_unique<GDSFunction>(name,
        std::make_unique<ParallelMegaSPPaths>());
