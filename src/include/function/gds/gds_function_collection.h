...
struct ParallelMegaSPLengthsFunction {
    static constexpr const char* name = "ParallelMegaSPLength";
...
struct ParallelMSBFSVarLenPathsFunction {
    static constexpr const char* name = "ParallelMSBFSVarLenPath";
