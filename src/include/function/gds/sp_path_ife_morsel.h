...
struct SPPathIFEMorsel : public IFEMorsel {
public:
    SPPathIFEMorsel(uint64_t upperBound_, uint64_t lowerBound_, uint64_t maxNodeOffset_,
...
public:
    ...
    std::vector<common::offset_t> parentOffset;
    std::vector<common::offset_t> edgeOffset;
