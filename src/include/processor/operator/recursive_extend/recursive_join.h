...
private:
    ...
    bool doMSBFS(uint16_t * seen, uint16_t * curFrontier, uint16_t * nextFrontier, uint64_t maxOffset,
        kuzu::processor::ExecutionContext* context);

    void callMSBFSRecursivePlan(const uint16_t * seen, const uint16_t * curFrontier,
