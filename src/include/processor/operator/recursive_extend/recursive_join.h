...
private:
    ...
    bool doMSBFS(uint8_t * seen, uint8_t* curFrontier, uint8_t* nextFrontier, uint64_t maxOffset,
        kuzu::processor::ExecutionContext* context);

    void callMSBFSRecursivePlan(const uint8_t* seen, const uint8_t* curFrontier,
