...
public:
    BFSLevelMorsel(uint32_t startIdx, uint32_t bfsLevelMorselSize)
        : startIdx{startIdx}, bfsLevelMorselSize{bfsLevelMorselSize} {}

    inline bool isEmpty() const { return bfsLevelMorselSize == 0u; }
