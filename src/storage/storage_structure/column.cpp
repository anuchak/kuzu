...
void Column::read(
    Transaction* transaction, const ValueVector& nodeIDVector, ValueVector& resultVector) {
...
void Column::writeValues(const ValueVector& nodeIDVector, const ValueVector& vectorToWriteFrom) {
...
void Column::lookup(Transaction* transaction, const ValueVector& nodeIDVector,
    ValueVector& resultVector, uint32_t vectorPos) {
...
void Column::lookup(Transaction* transaction, ValueVector& resultVector, uint32_t vectorPos,
...
WALPageIdxPosInPageAndFrame Column::beginUpdatingPage(
    offset_t nodeOffset, const ValueVector& vectorToWriteFrom, uint32_t posInVectorToWriteFrom) {
